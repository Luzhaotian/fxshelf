...
- 也可用 jsDelivr：`https://cdn.jsdelivr.net/npm/@fxshelf/starfield/dist/starfield.iife.js`
- 生产环境建议锁定版本：`@fxshelf/starfield@0.1.1/...`（例如 `https://unpkg.com/@fxshelf/starfield@0.1.1/dist/starfield.iife.js`）
